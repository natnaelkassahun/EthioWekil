    ...
    return ( 
        <div className="product__card__card">
            <div className="product__card">
                ...
                > 
                {isHovered? <img src={`http://ethio-wekil-backend.vercel.app/public/${props.item.category}/${props.item.image[1].filename}`} alt="item" className="product__img"/>: <img src= {`http://ethio-wekil-backend.vercel.app/public/${props.item.category}/${props.item.image[0].filename}`} alt="item" className="product__img"/> }
                </div>
