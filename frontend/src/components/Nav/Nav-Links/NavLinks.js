            ...
            <nav className="nav__bottom__container">
                <div className="bottom__container">
                    <ul className="nav">
                        ...
                        <li className='nav-link'><Link to="/account/login">{languageContext.dictionary["login"]}</Link></li> 
                        <li className='nav-link'><Link to="/account/register">{languageContext.dictionary["signUp"]}</Link></li> 
